...
const UpdateJob = () => {
    const { id } = useParams()
    //console.log(id);
    const { _id, scholarTitle, companyName, minPrice, maxPrice, category, location, postingDate, experienceLevel, companyLogo, scholarType, description, postedBy, skills } = useLoaderData();
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className=' create-job-flex'>
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="text" defaultValue={scholarTitle} {...register("scholarTitle")} className='create-job-input' />
                        </div>
                    ...
                    <div className='mt-8 create-job-flex'>
                        ...
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <select {...register("scholarType")} defaultValue={scholarType} className='create-job-input'>
                    ...
                    <div className='w-full mt-8'>
                        ...
                        <textarea className='w-full pl-3 py-1.5 focus:outline-none placeholder:text-gray-700'
                            rows={6} placeholder='description' defaultValue={description}
                    ...
                    <div className='create-job-flex mt-8'>
                        ...
                        <div className=' lg:w-1/2 w-full '>
                            ...
                            <input type="url" placeholder='http://example.com' defaultValue={companyLogo} {...register("companyLogo")} className='create-job-input' />
                        </div>
                    </div>
